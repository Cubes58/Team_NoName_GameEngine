...
PhysicsObject::PhysicsObject(const std::string &p_ModelName, const glm::vec3& p_Pos, const glm::vec3& p_AABBSize, const glm::quat &p_ModelOrientation, const glm::vec3& p_ModelScale, float p_Mass, float p_Rest, float p_DragCo, float p_FrictionCo)
{
...
void PhysicsObject::OnUpdate(float p_DeltaTime)
{
	...
	GetComponent<AABBComponent>()->SetPosition(l_Pos);
}
